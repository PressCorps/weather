$(window).on('load', function() {
  ...
  function centerAndZoomMap(points) {
    ...
    if (getSetting('_greatmarchLat') !== '') {
      lat = getSetting('_greatmarchLat');
      latSet = true;
    }

    if (getSetting('_greatmarchLon') !== '') {
      lon = getSetting('_greatmarchLon');
      lonSet = true;
    }

    if (getSetting('_greatmarchZoom') !== '') {
      zoom = parseInt(getSetting('_greatmarchZoom'));
      zoomSet = true;
    }
