$(window).on('load', function() {
  ...
  function centerAndZoomMap(points) {
    ...
    if (getSetting('_terminusLat') !== '') {
      lat = getSetting('_terminusLat');
      latSet = true;
    }

    if (getSetting('_terminusLon') !== '') {
      lon = getSetting('_terminusLon');
      lonSet = true;
    }

    if (getSetting('_terminusZoom') !== '') {
      zoom = parseInt(getSetting('_terminusZoom'));
      zoomSet = true;
    }
