$(window).on('load', function() {
  ...
  function centerAndZoomMap(points) {
    ...
    if (getSetting('_ashfieldsLat') !== '') {
      lat = getSetting('_ashfieldsLat');
      latSet = true;
    }

    if (getSetting('_ashfieldsLon') !== '') {
      lon = getSetting('_ashfieldsLon');
      lonSet = true;
    }

    if (getSetting('_ashfieldsZoom') !== '') {
      zoom = parseInt(getSetting('_ashfieldsZoom'));
      zoomSet = true;
    }
