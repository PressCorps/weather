$(window).on('load', function() {
  ...
  function centerAndZoomMap(points) {
    ...
    if (getSetting('_redriverLat') !== '') {
      lat = getSetting('_redriverLat');
      latSet = true;
    }

    if (getSetting('_redriverLon') !== '') {
      lon = getSetting('_redriverLon');
      lonSet = true;
    }

    if (getSetting('_redriverZoom') !== '') {
      zoom = parseInt(getSetting('_redriverZoom'));
      zoomSet = true;
    }
